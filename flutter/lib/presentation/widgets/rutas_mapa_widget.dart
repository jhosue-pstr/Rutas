...
//   final RutaCompleta? rutaEspecifica; // Para mostrar una ruta calculada
//   final bool mostrarTodasLasRutas; // Para mostrar todas las rutas del sistema
...
//       // Modo: Mostrar ruta específica calculada
//       await _configurarRutaEspecifica();
//     } else if (widget.mostrarTodasLasRutas) {
//       // Modo: Mostrar todas las rutas del sistema
...
//   // 🔥 MODO: RUTA ESPECÍFICA CALCULADA
...
//   // 🔥 MODO: TODAS LAS RUTAS DEL SISTEMA
...
//     for (final segmento in ruta.segmentos) {
//       final color = segmento.esBus ? Colors.blue : Colors.green;
...
//   // 🔥 CÓDIGO DE TU RutasMapaWidget (para mostrar todas las rutas)
...
//       // Agregar marcadores de inicio/fin de rutas
...
//   // 🔥 MÉTODOS DE TU RutasMapaWidget (optimizados)
...
//     LatLng puntoInicial = const LatLng(
//       -15.4999,
//       -70.1376,
//     ); // Juliaca por defecto
